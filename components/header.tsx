          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                ...
                <p>
                  Whover guesses the right word first wins the the game. If you
                  play for ETH, each player transfers ETH for each guess. The
                  winner is transferred all the ETH. If the game is a draw, the
                  pot is split evenly.
                </p>
              </DialogDescription>
            </DialogHeader>

...
export default function GetETH() {
  ...
  return wallet?.connectorType === 'injected' ? (
    <div className="flex flex-col max-w-md mx-auto gap-4 py-28 px-8">
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-sm">
          ...
          shown below. If you don't have any Base ETH, you can bridge your ETH{' '}
          <Link
            target="_blank"
            className="underline"
      ...
      <p className="text-sm">
        Once there is ETH in your wallet, you'll be able to play. We recommend
        at least 0.001 ETH to pay for gas.
      </p>
    </div>
  ) : (
    <div className="flex flex-col max-w-md mx-auto gap-4 py-28 px-8 text-center">
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-sm">
          ...
          , to play WordDuel. Notify us and we'll send you some to your account.
        </p>
      </div>
